...
class FSM_State_SitDown final : public FSM_State {
public:
    FSM_State_SitDown(Control_FSM_Data *_controlFSMData, Control_Parameters_t *control_para);

    ~FSM_State_SitDown() override = default;
